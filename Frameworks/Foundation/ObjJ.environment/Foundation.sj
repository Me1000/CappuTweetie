...
p;20;_CPJavaScriptArray.jt;4567;@STATIC;1.0;i;16;CPMutableArray.jt;4527;
objj_executeFile("CPMutableArray.j",YES);
var _1=Array.prototype.indexOf,_2=Array.prototype.join,_3=Array.prototype.pop,_4=Array.prototype.push,_5=Array.prototype.slice,_6=Array.prototype.splice;
var _7=objj_allocateClassPair(CPMutableArray,"_CPJavaScriptArray"),_8=_7.isa;
objj_registerClassPair(_7);
class_addMethods(_7,[new objj_method(sel_getUid("initWithArray:"),function(_9,_a,_b){
with(_9){
return _5.call(_b,0);
}
...
_c=objj_msgSendSuper({receiver:_c,super_class:objj_getClass("_CPJavaScriptArray").super_class},"init");
var _10=0;
if(_e.isa===_CPJavaScriptArray){
var _11=_e.length;
for(;_10<_11;++_10){
var _12=_e[_10];
_c[_10]=_12.isa?objj_msgSend(_12,"copy"):_12;
}
return _c;
}
var _11=objj_msgSend(_e,"count");
for(;_10<_11;++_10){
var _12=objj_msgSend(_e,"objectAtIndex:",_10);
_c[_10]=_12.isa?objj_msgSend(_12,"copy"):_12;
}
return _c;
}
}),new objj_method(sel_getUid("initWithObjects:"),function(_13,_14,_15){
with(_13){
var _16=2,_17=arguments.length;
for(;_16<_17;++_16){
if(arguments[_16]===nil){
break;
}
}
return _5.call(arguments,2,_16);
}
}),new objj_method(sel_getUid("initWithObjects:count:"),function(_18,_19,_1a,_1b){
with(_18){
if(_1a.isa===_CPJavaScriptArray){
return _5.call(_1a,0);
}
var _1c=[],_1d=0;
for(;_1d<_1b;++_1d){
_4.call(_1c,objj_msgSend(_1a,"objectAtIndex:",_1d));
}
return _1c;
}
...
}),new objj_method(sel_getUid("objectAtIndex:"),function(_20,_21,_22){
with(_20){
if(_22>=_20.length||_22<0){
_CPRaiseRangeException(_20,_21,_22,_20.length);
}
return _20[_22];
}
}),new objj_method(sel_getUid("indexOfObject:inRange:"),function(_23,_24,_25,_26){
with(_23){
if(_25&&_25.isa){
var _27=_26?_26.location:0,_28=_26?CPMaxRange(_26):_23.length;
for(;_27<_28;++_27){
if(objj_msgSend(_23[_27],"isEqual:",_25)){
return _27;
}
}
return CPNotFound;
}
return objj_msgSend(_23,"indexOfObjectIdenticalTo:inRange:",_25,_26);
}
}),new objj_method(sel_getUid("indexOfObjectIdenticalTo:inRange:"),function(_29,_2a,_2b,_2c){
with(_29){
if(_1&&!_2c){
return _1.call(_29,_2b);
}
...
return _5.call(_35,_37.location,CPMaxRange(_37));
}
}),new objj_method(sel_getUid("componentsJoinedByString:"),function(_38,_39,_3a){
with(_38){
return _2.call(_38,_3a);
}
}),new objj_method(sel_getUid("insertObject:atIndex:"),function(_3b,_3c,_3d,_3e){
with(_3b){
_6.call(_3b,_3e,0,_3d);
}
...
class_addMethods(_8,[new objj_method(sel_getUid("alloc"),function(_4f,_50){
with(_4f){
return [];
}
