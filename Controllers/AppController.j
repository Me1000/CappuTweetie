...
- (void)didDoubleClick:(id)sender
{
    ...
    var sender = [[sender superview] superview],
        ...
        endRect =  CGRectMake(20, 53, [sender frame].size.width + 40, [sender frame].size.height + 40),
        newWindow = [[CPWindow alloc] initWithContentRect:newWindowRect styleMask:CPBorderlessWindowMask];
